-- sample run on gpu: th mlp.lua --gpu
...
-- build the model
-- build the model
local linearLayer = nn.Linear(28*28,64)
linearLayer.weights = torch.rand(28*28,64)*0.1
linearLayer.bias = torch.zeros(64)
local linearLayer2 = nn.Linear(64,10)
linearLayer2.weights = torch.rand(64,10)*0.1
linearLayer2.bias = torch.zeros(10)
